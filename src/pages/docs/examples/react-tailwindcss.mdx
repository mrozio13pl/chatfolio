import { Chat } from '~/examples/react+tailwindcss';

<Chat />

# React + TailwindCSS

Simple chat example written in React with Tailwindcss.<br />
Uses [marked](https://github.com/markedjs/marked) for parsing markdown and [github-markdown-css](https://github.com/sindresorhus/github-markdown-css) for styling it.<br />
This example also uses [lucide](https://lucide.dev/) icons but feel free to replace them with any other you'd like.

Install dependencies.

```sh npm2yarn copy
npm i marked github-markdown-css dompurify clsx lucide-react
```

Usage:

```tsx copy filename="chat.tsx" showLineNumbers
